    ...
    <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <form action={signInWithEmail} className="space-y-2">
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
        />
        <button
          type="submit"
