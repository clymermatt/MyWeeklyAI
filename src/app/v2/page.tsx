      ...
      <section className="px-4 pb-16">
        <FadeIn>
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            AI updates from industry labs and publications. Hand-picked and decoded FOR YOU by Claude.
          </p>
        </FadeIn>
      </section>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <FadeIn delay={200}>
            <p className="mt-8 text-base font-medium text-gray-500">
              ...
              <br />
              <span className="text-purple-600">Just the signal you need to stay sharp in your work.</span>
            </p>
          </FadeIn>
        </div>
      </section>
