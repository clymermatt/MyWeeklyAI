    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white px-4 py-20">
        <div className="mx-auto max-w-4xl">
          <FadeIn>
            <h2 className="text-center text-3xl font-bold text-gray-900">
              See examples for your role
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-center text-gray-600">
              Every role gets a different brief. See what yours looks like.
            </p>
          </FadeIn>
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              {
                title: "Founders",
                href: "/for/ceo-founders",
              },
              {
                title: "Executives",
                href: "/for/cto-vp-engineering",
              },
            ].map((role, i) => (
              <FadeIn key={role.href} delay={i * 60}>
                <Link
                  href={role.href}
                  className="group flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 transition-all hover:-translate-y-0.5 hover:border-purple-200 hover:shadow-md"
                >
                  <span className="font-medium text-gray-900 group-hover:text-purple-600">
                    {role.title}
                  </span>
                  <svg
                    className="h-4 w-4 text-gray-400 transition-transform group-hover:translate-x-1 group-hover:text-purple-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={2}
                    stroke="currentColor"
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <FadeIn delay={200}>
            <p className="mt-4 text-lg text-gray-600">
              So I built MyWeekly — the tool I wished existed. An AI that reads
